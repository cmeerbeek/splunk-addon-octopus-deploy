...
require([
  ...
  var mainSearch = new searchManager({
    ...
    search: "sourcetype=octopus:deployments earliest=-90d@d latest=now | rename Id as DeploymentId | join EnvironmentId [ search sourcetype=octopus:environments | rename Id as EnvironmentId, Name as EnvironmentName ] | join ProjectId [ search sourcetype=octopus:projects | rename Id as ProjectId, Name as ProjectName ] | timechart count(DeploymentId)  span=1month by EnvironmentName",
  });
