require.config({
  paths: {
    d3: '../app/TA-Octopus-Sh/bower_components/d3/d3.min',
    calheatmap: '../app/TA-Octopus-Sh/bower_components/cal-heatmap/cal-heatmap',
  },
  shim: {
    d3v3: {
      deps: []
...
require([
  ...
  var mainSearch = new searchManager({
    ...
    search: "sourcetype=octopus:deployments | bucket _time span=1d | stats count by _time",
  });
